...
const dictionaries = {
    en: {
        ...
        'help.tip.trash.applySolid': '<p>Applies the solid areas edited in Solid Mode to the alpha.<br>This cannot be undone.</p>',
    ...
    ja: {
        ...
        'help.tip.trash.applySolid': '<p>ソリッドモードで編集したソリッド部分をアルファに適用します。<br>Undoの対象外です。通常利用する必要はありません。</p>',
